<template>
    <div>
        <ui-dropsearch>
            <el-tooltip content="订单号" placement="top" :open-delay="2000">
                <el-input class="ui-input-w" placeholder="订单号"></el-input>
            </el-tooltip>
            <el-tooltip content="结算时间" placement="top" :open-delay="2000">
                <el-date-picker v-model="settleTime" type="datetime" placeholder="结算时间">
                </el-date-picker>
            </el-tooltip>
            <el-tooltip content="来源店铺" placement="top" :open-delay="2000">
                <el-input class="ui-input-w" placeholder="来源店铺"></el-input>
            </el-tooltip>
            <el-tooltip content="来源推客" placement="top" :open-delay="2000">
                <el-input class="ui-input-w" placeholder="来源推客"></el-input>
            </el-tooltip>
            <el-tooltip content="来源手机" placement="top" :open-delay="2000">
                <el-input class="ui-input-w" placeholder="来源手机"></el-input>
            </el-tooltip>
            <el-tooltip content="订单状态" placement="top" :open-delay="2000">
                <el-select placeholder="订单状态">
                    <el-option label="全部" value="all"></el-option>
                    <el-option label="区域二" value="beijing"></el-option>
                </el-select>
            </el-tooltip>
            <el-tooltip content="收货地址" placement="top" :open-delay="2000">
                <el-select placeholder="收货地址">
                    <el-option label="全部" value="all"></el-option>
                    <el-option label="区域二" value="beijing"></el-option>
                </el-select>
            </el-tooltip>
