<template>
    <div>
        <add :title="ticketName" subtitle="消费者对X产品发布测评文章获取100%返款" :ticketData="ticketData" :ticketColor="ticketColor" :ticketAdd="showDialog"></add>
        ...
        <el-dialog :title="'添加'+ticketName" v-model="dialogVisable" top="5%">
            <el-form :model="form" ref="form" :rules="rules" label-width="120px">
                ...
                <el-form-item label="规则设置">
                    <el-checkbox v-model="form.cashback" label="文章确认后获得返款" />
                </el-form-item>
