<template>
    <div>
        <add :title="ticketName" subtitle="每个用户限购x件某产品" :ticketData="ticketData" :ticketColor="ticketColor" :ticketAdd="showDialog"></add>
        ...
        <el-dialog :title="'添加'+ticketName" v-model="dialogVisable" top="5%">
            <el-form :model="form" ref="form" :rules="rules" label-width="120px">
                ...
                <el-form-item label="规则设置">
                    <el-input v-model="form.limit" style="width:200px">
                        <span slot="prepend">每人限</span>
                        <span slot="append">件</span>
                    </el-input>
                    <span class="f-color-grey f-10 p-l-15">限购期内商品的总购买数超过则不可买</span>
                </el-form-item>
